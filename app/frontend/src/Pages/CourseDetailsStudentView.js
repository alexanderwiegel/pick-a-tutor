...
function CourseDetailsStudentView(props) {
    ...
    const [toReportReviewID, setToReportReviewID] = useState(0);
    ...
    const handleReportModalShow = (reviewID) => {
        setToReportReviewID(reviewID);
                ...
                <Row className="mb-3">
                    ...
                    <Col md={7}>
                        ...
                        <Button
                            ...
                            href={"/chat/" + courseDetails[0].User.id}
                        >
                            Contact tutor
                        </Button>
                    </Col>
                            ...
                            <Card className="mb-2">
                                <Card.Body>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => handleReportModalShow(review.id)}
                                    >
                                        Report
                                    </Button>
                                    <Modal
                                    ...
                                    >
                                        <Modal.Header closeButton>
                                            <Modal.Title>
                                                ...
                                                reporting this review! {toReportReviewID}
                                            </Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <ReviewReportForm reviewID={toReportReviewID}/> 
                                        </Modal.Body>
                                    </Modal>
                                </Card.Body>
                            </Card>
