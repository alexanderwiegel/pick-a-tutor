...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 02, 2021 at 10:44 AM
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `mobile_country_code` varchar(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_no` int DEFAULT NULL,
  `house_no` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user_courses` (
  ...
  `user_id` int DEFAULT NULL COMMENT 'Tutor''s users table id',
  `course_duration` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Days or Months details',
...
CREATE TABLE IF NOT EXISTS `user_enrolled_courses` (
  ...
  `user_id` int DEFAULT NULL COMMENT 'Student User ID in "users" table',
...
CREATE TABLE IF NOT EXISTS `user_enrolled_reviews` (
  ...
  `rating_comments` text COLLATE utf8mb4_unicode_ci,
  `report_review` tinyint NOT NULL DEFAULT '0' COMMENT 'Tutor reported Review:\r\n0:Not Reported, 1:Reported',
  `report_review_comments` text COLLATE utf8mb4_unicode_ci COMMENT 'Comments by Tutor upon reporting review',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `user_profiles` (
  ...
  `image_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'profile image saved path',
  `cv_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CV saved path',
  `video_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CV saved path',
  `audio_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'audio file saved path',
  `youtube_video_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'YouTube Path',
  `created_at` timestamp NULL DEFAULT NULL,
